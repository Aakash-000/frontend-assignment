...
const Navbar = () => {
  ...
  return (
    ...
    <header className="shadow-md">
        <nav className="flex flex-row items-center justify-evenly bg-navbg p-2 sticky top-0  z-10">
        <h1 className="text-3xl font-extrabold">
        <Link href="/" className="text-logocolor no-underline hover:text-white">
        ECO.CO
        </Link>
        </h1>
        <div className="relative nav-search">
        <svg className="absolute top-3 left-3" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
